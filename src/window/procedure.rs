...
//     (0, WindowsAndMessaging::WM_NCCREATE) => on_nccreate(hwnd, msg, w_param,
// l_param),     (0, WindowsAndMessaging::WM_CREATE) => on_create(hwnd, msg,
// w_param, l_param),     _ => unsafe { DefWindowProcW(hwnd, msg, w_param,
// l_param) },   }
// }

// fn on_nccreate(hwnd: HWND, msg: u32, w_param: WPARAM, l_param: LPARAM) ->
// LRESULT {   if unsafe {
...
// fn on_create(hwnd: HWND, msg: u32, w_param: WPARAM, l_param: LPARAM) ->
// LRESULT {   let create_struct = unsafe { (l_param.0 as *mut
// CREATESTRUCTW).as_mut().unwrap() };   let create_info = unsafe {
...
//   dw_ref_data: usize,
// ) -> LRESULT {
//   let data: &mut SubclassWindowData = unsafe {
// std::mem::transmute(dw_ref_data) };
...
//         unsafe { PostMessageW(hwnd, WindowsAndMessaging::WM_APP, WPARAM(0),
// LPARAM(0)) }           .unwrap();
//       }
//     }
