...
// //     Graphics::Gdi::{GetDC, GetMonitorInfoW, HMONITOR, MONITORINFO,
// MONITORINFOEXW}, //     System::{
...
// /*
//   Some of the following code was taken directly from `winit` and is currently
// under the Apache-2.0 copyright.
//   > https://github.com/rust-windowing/winit/blob/master/src/platform_impl/windows/
//   Some functions are simplified to be more specific to the goals of ezwin or
// reduce dependencies.   Changes were also made to adapt from the crate
...
// NTSTATUS;     let handle = get_function!("ntdll.dll", RtlGetVersion);
...
//   let mut style =
//     WindowsAndMessaging::WS_EX_WINDOWEDGE |
...
//     monitor_info.monitorInfo.cbSize = std::mem::size_of::<MONITORINFOEXW>()
// as u32;     let status = unsafe {
//       GetMonitorInfoW(
//         self.hmonitor,
...
//     let mut _dpi_y = 0;
//     unsafe {
//       GetDpiForMonitor(self.hmonitor, HiDpi::MDT_EFFECTIVE_DPI, &mut dpi_x,
// &mut _dpi_y)     }
//     .unwrap();
